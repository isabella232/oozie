...
public class TestBufferDrainer extends DrainerTestCase {
    ...
    private void checkDrainBuffers(final int runningSteps, String outputString, String errorString, int maxLength) throws IOException {
    ...
    private Thread createBufferDrainerThread(final  Process process, final String randomizedOutputString,
                                             final String randomizedErrorString, final int maxLength) {
        return new Thread() {
            public void run() {
                try {
