...
"TLS_RSA_WITH_AES_128_CBC_SHA256,TLS_RSA_WITH_AES_128_CBC_SHA,TLS_RSA_WITH_3DES_EDE_CBC_SHA,TLS_DHE_RSA_WITH_AES_256_CBC_SHA256,"\
"TLS_DHE_RSA_WITH_AES_256_CBC_SHA,TLS_DHE_RSA_WITH_AES_128_CBC_SHA256,TLS_DHE_RSA_WITH_AES_128_CBC_SHA,"\
"TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA"
  print "Setting OOZIE_HTTPS_CIPHERS:     ${OOZIE_HTTPS_CIPHERS}"
else
  print "Using   OOZIE_HTTPS_CIPHERS:     ${OOZIE_HTTPS_CIPHERS}"
fi
